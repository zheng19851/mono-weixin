 ...
 * @author zhengwei
 */
public class RetryHttpClientService implements HttpClientService {
    ...
    private HttpClientService    delegate;

    private RetryTemplate retryTemplate = new RetryTemplate();

    @Override
    public Result<String> executeGet(final String apiUrl) throws HttpException {
    ...
    @Override
    public Result<String> executeGet(final String apiUrl, final Map<String, String> getParams) throws HttpException {
        return retryTemplate.execute(new Callback<String>() {
    ...
    @Override
    public Result<String> executePost(final String apiUrl, final String postParams) throws HttpException {
        return retryTemplate.execute(new Callback<String>() {
    ...
    @Override
    public Result<JSONObject> doGet(final String apiUrl) throws HttpException {
    ...
    @Override
    public Result<JSONObject> doGet(final String apiUrl, final Map<String, String> getParams) throws HttpException {
        return retryTemplate.execute(new Callback<JSONObject>() {
    ...
    public HttpClientService getDelegate() {
        return delegate;
    }

    public void setDelegate(HttpClientService delegate) {
